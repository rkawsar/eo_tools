...
#directories
input_dir = '/media/Arc/eo_archive_proc/MOD09Q1/downloads/h18v04'
output_dir = '/media/Arc/eo_archive_proc/MOD09Q1/output/h18v04'
...
if __name__ == '__main__':
    ...
    endTime = time.time()
    # sending all the new files into the SBINC01...
    subprocess.call(['/media/Num/eo_tools/bin/system_administration/sync_mod09q1_data.sh'])
